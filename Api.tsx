 ...
 *
 * Deliberately not cached. Remembering the first answer for the tab would be
 * right for a real product — nobody changes country mid-session — but this
 * endpoint flips on purpose, and that flip is the thing being demonstrated.
 * A cache would freeze the currency on whichever side the first roll landed,
 * so a reload would never show the other one. Asking every time costs one
 * request and keeps both currencies reachable.
 */
